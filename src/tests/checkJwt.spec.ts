...
describe('Check jwt middleware', function() {
	...
	it('returns status 401 if jwt isnt verified', async function() {
		const request = {
			headers: {
				authorization:
					'bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImVtYWlsIjoiYWRtaW5AYWRtaW4uZGsiLCJyb2xlcyI6WyJBRE1JTiIsIlRVVE9SIl0sImlhdCI6MTU3NDg5MzM0NSwiZXhwIjoxNTc0ODk2OTQ1fQ.J79OIIrwx2zhOH4fWZGS90b1RGNNMM3u5eHDr2Xqa0k',
			},
		};
